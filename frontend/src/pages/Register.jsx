...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    register({
      name: formData.name || "CPL Player",
      email: formData.email,
      phone: "000-000-0000",
      age: "24",
      city: "Mumbai",
      role: roleMap[formData.role] || "Batsman",
    });
    setShowSuccess(true);
    setTimeout(() => {
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-300">
            Create your account and be part of the revolution
          </p>
        </div>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400"
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full pl-10 pr-10 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400"
          ...
          >
            ...
            >
              ...
              <p className="text-slate-300 mb-4">
                Welcome to CPL 2026! Your account has been created.
              </p>
