...
const UmpireRegistration = () => {
  ...
  const certifications = [
    "ICC Level 1 Certification",
    "ICC Level 2 Certification",
    "ICC Level 3 Certification",
    "BCCI Umpiring Certification",
    "Cricket Australia Umpiring Certificate",
    "ECB Umpiring Qualification",
    "Third Umpire Certification",
    "DRS Training Certificate",
  ];
  ...
  const handleSpecializationToggle = (spec) => {
    setFormData((prev) => ({
      ...
      professionalInfo: {
        ...prev.professionalInfo,
        specializations: prev.professionalInfo.specializations.includes(spec)
          ? prev.professionalInfo.specializations.filter((s) => s !== spec)
          : [...prev.professionalInfo.specializations, spec],
      },
    }));
  };
  ...
  const handleSubmit = () => {
    ...
    console.log("Submitting umpire registration:", formData);
  };
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Join CPL as a certified umpire and be part of the most prestigious
            cricket league
          </p>
        </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-cyan-400 pr-12"
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    className="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-cyan-400"
                    value={formData.professionalInfo.level}
                    onChange={(e) =>
                      handleInputChange(
                        "professionalInfo",
                        "level",
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {specializations.map((spec) => (
                      <label key={spec} className="flex items-center space-x-3">
                        <input
                          type="checkbox"
                          checked={formData.professionalInfo.specializations.includes(
                            spec,
                          )}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="List tournaments, matches, and levels you've umpired at (e.g., IPL, Ranji Trophy, International matches)"
                    value={formData.professionalInfo.previousMatches}
                    onChange={(e) =>
                      handleInputChange(
                        "professionalInfo",
                        "previousMatches",
        ...
        >
          <h3 className="text-xl font-bold text-white mb-4">
            Umpire Registration Requirements
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <div className="text-slate-400 text-sm">18 years old</div>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5" />
            ...
            <div className="flex items-start space-x-3">
              <CheckCircle className="w-5 h-5 text-green-400 mt-0.5" />
              <div>
                <div className="text-white font-semibold">Medical Fitness</div>
                <div className="text-slate-400 text-sm">
...
export default UmpireRegistration;
